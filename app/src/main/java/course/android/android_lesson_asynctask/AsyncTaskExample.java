...
public class AsyncTaskExample extends Activity {
    ...
    class DownloadMusicfromInternet extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String file_url) {
            ...
            Toast.makeText(getApplicationContext(), "Download completed, playing music", Toast.LENGTH_LONG).show();
            // Play the music
            playMusic();
        }
    }
        ...
        try {
            ...
            mPlayer.setOnCompletionListener(new OnCompletionListener() {
                public void onCompletion(MediaPlayer mp) {
                    ...
                    Toast.makeText(getApplicationContext(), "Playing music completed", Toast.LENGTH_LONG).show();
                }
            });
        } catch (IllegalArgumentException e) {
            Toast.makeText(getApplicationContext(), "You might have not set the URI correctly!", Toast.LENGTH_LONG).show();
        } catch (SecurityException e) {
            Toast.makeText(getApplicationContext(), "URI cannot be accessed, permission needed", Toast.LENGTH_LONG).show();
        } catch (IllegalStateException e) {
            Toast.makeText(getApplicationContext(), "Media Player is not in the correct state", Toast.LENGTH_LONG).show();
        } catch (IOException e) {
