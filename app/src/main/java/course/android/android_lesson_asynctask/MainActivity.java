package course.android.android_lesson_asynctask;
...
public class MainActivity extends Activity {
    ...
    // Music resource URL
    private static String file_url = "https://github.com/m-rakowski/android-lesson6/raw/master/src/main/res/raw/staying_alive.mp3";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnPlayMusic.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                File file = new File(Environment.getExternalStorageDirectory().getPath() + "/staying_alive.mp3");
    ...
    class DownloadMusicfromInternet extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... f_url) {
            ...
            try {
                ...
                OutputStream output = new FileOutputStream(Environment.getExternalStorageDirectory().getPath() + "/staying_alive.mp3");
    ...
    protected void playMusic() {
        ...
        Uri myUri1 = Uri.parse(Environment.getExternalStorageDirectory().getPath() + "/staying_alive.mp3");
        ...
        try {
            ...
            Handler handler = new Handler(mPlayer, seekBar);
            handler.execute();
...
class Handler extends AsyncTask<Void, Void, Void> {
    ...
    Handler(MediaPlayer player, SeekBar bar) {
        this.player = player;
        this.bar = bar;
    }
